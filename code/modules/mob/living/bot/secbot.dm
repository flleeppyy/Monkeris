...
#define SECBOT_SUMMON		6		// summoned by PDA
	...
	var/control_freq = FREQ_BOT		// Bot control frequency
	var/list/path = list()
	var/frustration = 0
...
/obj/item/clothing/head/armor/helmet/attackby(obj/item/device/assembly/signaler/S, mob/user as mob)
	...
	if(type != /obj/item/clothing/head/armor/helmet) //Eh, but we don't want people making secbots out of space helmets.
		return
...
/obj/item/secbot_assembly/attackby(obj/item/I, mob/user)
	..()
	...
	else if(isproxsensor(I) && (build_step == 1))
		user.drop_item()
		build_step = 2
