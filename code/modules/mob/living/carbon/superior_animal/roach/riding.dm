/mob/living/carbon/superior_animal/roach/Move(NewLoc, Dir, step_x = 0, step_y = 0, glide_size_override = 0)
	. = ..()
	if(buckled_mob)
		buckled_mob.dir = dir
...
/mob/living/carbon/superior_animal/roach/proc/try_tame(mob/living/carbon/user, obj/item/reagent_containers/food/snacks/grown/thefood)
	if(!istype(thefood))
		return FALSE
	if(prob(40))
