...
/datum/interface/AI_Eris/buildUI()
	...
	getElementByID("Crew sensors").setClickProc(TYPE_PROC_REF(/mob/living/silicon, show_crew_sensors), _observer.mob)
	getElementByID("Subsystems").setClickProc(TYPE_PROC_REF(/mob/living/silicon, activate_subsystem), _observer.mob)
	getElementByID("Email").setClickProc(TYPE_PROC_REF(/mob/living/silicon, show_email), _observer.mob)
	getElementByID("Show Alerts").setClickProc(TYPE_PROC_REF(/mob/living/silicon, show_alerts), _observer.mob)
