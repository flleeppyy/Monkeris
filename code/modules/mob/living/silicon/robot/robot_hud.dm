...
//		var/atom/movable/screen/inventory/inv_box = new HUDtype(HUDname, HUDdatum.slot_data[HUDname]["loc"],HUDdatum.icon,HUDdatum.slot_data[HUDname]["icon"] ? HUDdatum.icon,HUDdatum.slot_data[HUDname]["icon"] : ,HUDdatum.icon,HUDdatum.slot_data[HUDname]["icon_state"],H, HUDdatum.slot_data.Find(HUDname))

		var/atom/movable/screen/silicon/inv_box = new HUDtype(HUDname, HUDdatum.slot_data[HUDname]["loc"], \
...
//		var/atom/movable/screen/HUD = new HUDtype(HUDname, HUDdatum.HUDneed[HUDname]["loc"], H)
...
/mob/living/silicon/robot/create_HUDfrippery()
	...
	for (var/list/whistle in HUDdatum.HUDfrippery)
		var/atom/movable/screen/frippery/F = new (whistle["icon_state"],whistle["loc"], whistle["dir"],H)
...
/mob/living/silicon/robot/create_HUDtech()
	...
	for (var/techobject in HUDdatum.HUDoverlays)
		...
		var/atom/movable/screen/HUD = new HUDtype(_name = techobject, _parentmob = H)// _screen_loc = HUDdatum.HUDoverlays[techobject]["loc"]
