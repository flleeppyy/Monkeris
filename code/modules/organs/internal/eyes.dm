	...
	switch(damage_type)
		if(BRUTE)
			if(!edge)
				if(sharp)
					if(is_organic)
						LAZYADD(possible_wounds, subtypesof(/datum/internal_wound/organic/eyes_sharp))
					if(is_robotic)
						LAZYADD(possible_wounds, subtypesof(/datum/internal_wound/robotic/eyes_sharp))
				else
					if(is_organic)
						LAZYADD(possible_wounds, subtypesof(/datum/internal_wound/organic/eyes_blunt))
					if(is_robotic)
						LAZYADD(possible_wounds, subtypesof(/datum/internal_wound/robotic/eyes_blunt))
			else
				if(is_organic)
					LAZYADD(possible_wounds, subtypesof(/datum/internal_wound/organic/eyes_edge))
				if(is_robotic)
					LAZYADD(possible_wounds, subtypesof(/datum/internal_wound/robotic/eyes_edge))
		if(BURN)
			if(is_organic)
				LAZYADD(possible_wounds, subtypesof(/datum/internal_wound/organic/eyes_burn))
			if(is_robotic)
				LAZYADD(possible_wounds, subtypesof(/datum/internal_wound/robotic/eyes_emp_burn))
		if(TOX)
			if(is_organic)
				LAZYADD(possible_wounds, subtypesof(/datum/internal_wound/organic/eyes_poisoning))
		if(CLONE)
			if(is_organic)
