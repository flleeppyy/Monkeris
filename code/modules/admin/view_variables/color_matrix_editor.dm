// TODO: fix this maybe? or implement a way to show a preview of the character to the user. idk
// We dont have map views, or screens for some fucking reason. so you're gonna have to copy
// whatever the fuck is going on in preview.dm
