...
GLOBAL_VAR_INIT(movement_disabled, FALSE)
...
/client/proc/disable_movement()
	...
	GLOB.movement_disabled = !GLOB.movement_disabled
	if(GLOB.movement_disabled)
		message_admins("[src.ckey] used 'Disable all movement', killing all movement.")
		GLOB.movement_disabled_exception = usr.ckey
	else
