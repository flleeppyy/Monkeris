...
/proc/make_scrap_ammo(mob/living/user, obj/source, extra_material_points = 0)
	...
	var/list/array = list(
		...
		CAL_CLRIFLE = list(
			...
			".25 ammo strip (5 ammo, 1 point)" = list(1, /obj/item/ammo_magazine/slclrifle/scrap),
		...
		CAL_SHOTGUN = list(
			...
			".50 magazine (empty, 8 ammo, 5 points)" = list(5, /obj/item/ammo_magazine/m12/short/empty),
			".50 drum (empty, 16 ammo, 15 points)" = list(15, /obj/item/ammo_magazine/m12/empty),
