...
/datum/global_hud/New()
	...
	druggy = new /atom/movable/screen/fullscreen/tile("druggy")

	//that white blurry effect you get when you eyes are damaged
	blurry = new /atom/movable/screen/fullscreen/tile("blurry")

	nvg = new /atom/movable/screen/fullscreen("nvg_hud")
	nvg.plane = LIGHTING_PLANE
	thermal = new /atom/movable/screen/fullscreen("thermal_hud")
	meson = new /atom/movable/screen/fullscreen("meson_hud")
	science = new /atom/movable/screen/fullscreen("science_hud")
	...
	holomap = new /atom/movable/screen/fullscreen()
	...
	lightMask = newlist(
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "WEST,SOUTH to EAST,SOUTH+1"},
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "WEST,SOUTH+2 to WEST+1,NORTH"},
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "EAST-1,SOUTH+2 to EAST,NORTH"},
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "WEST+2,NORTH-1 to EAST-2,NORTH"},

		/atom/movable/screen{icon_state = "dither50"; screen_loc = "WEST,SOUTH:-32 to EAST,SOUTH"},
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "EAST:32,SOUTH to EAST,NORTH"},
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "EAST:32,SOUTH:-32"},
	)

	vimpaired = newlist(
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "WEST,SOUTH to WEST+4,NORTH"},
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "WEST+4,SOUTH to EAST-5,SOUTH+4"},
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "WEST+5,NORTH-4 to EAST-5,NORTH"},
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "EAST-4,SOUTH to EAST,NORTH"},
	...
	darkMask = newlist(
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "WEST+2,SOUTH+2 to WEST+4,NORTH-2"},
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "WEST+4,SOUTH+2 to EAST-5,SOUTH+4"},
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "WEST+5,NORTH-4 to EAST-5,NORTH-2"},
		/atom/movable/screen{icon_state = "dither50"; screen_loc = "EAST-4,SOUTH+2 to EAST-2,NORTH-2"},

		/atom/movable/screen{icon_state = "black"; screen_loc = "WEST,SOUTH to EAST,SOUTH+1"},
		/atom/movable/screen{icon_state = "black"; screen_loc = "WEST,SOUTH+2 to WEST+1,NORTH"},
		/atom/movable/screen{icon_state = "black"; screen_loc = "EAST-1,SOUTH+2 to EAST,NORTH"},
		/atom/movable/screen{icon_state = "black"; screen_loc = "WEST+2,NORTH-1 to EAST-2,NORTH"},

		/atom/movable/screen{icon_state = "black"; screen_loc = "WEST,SOUTH:-32 to EAST,SOUTH"},
		/atom/movable/screen{icon_state = "black"; screen_loc = "EAST:32,SOUTH to EAST,NORTH"},
		/atom/movable/screen{icon_state = "black"; screen_loc = "EAST:32,SOUTH:-32"},
	)

	for(var/atom/movable/screen/O in (lightMask + vimpaired + darkMask))
