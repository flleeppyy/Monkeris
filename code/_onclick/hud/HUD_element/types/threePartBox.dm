...
/atom/movable/hud_element/threePartBox
	...
	var/atom/movable/hud_element/_start_element
	var/atom/movable/hud_element/_middle_element
	var/atom/movable/hud_element/_end_element

/atom/movable/hud_element/threePartBox/New(icon/startIcon, icon/middleIcon, icon/endIcon)
	..()
...
/atom/movable/hud_element/threePartBox/Destroy()
	_start_element = null
	_middle_element = null
	_end_element = null
	. = ..()

/atom/movable/hud_element/threePartBox/proc/getMinWidth() //minimum width element can achieve by resizing
	return max(minTotalWidth, _start_element.getWidth() + _end_element.getWidth())

/atom/movable/hud_element/threePartBox/scaleToSize(width, height)
...
/atom/movable/hud_element/threePartBox/getWidth()
	return _start_element.getWidth() + _middle_element.getWidth() + _end_element.getWidth()

/atom/movable/hud_element/threePartBox/getHeight()
	return max(_start_element.getHeight(), _middle_element.getHeight(), _end_element.getHeight())

/atom/movable/hud_element/threePartBox/setName(new_name, nameAllElements = FALSE)
