...
/decl/hierarchy/outfit/job/medical/cmo
	name = OUTFIT_JOB_NAME(JOB_MOEBIUS_BIOLAB_OFFICER)
...
/decl/hierarchy/outfit/job/medical/doctor
	name = OUTFIT_JOB_NAME(JOB_MOEBIUS_DOCTOR)
...
/decl/hierarchy/outfit/job/medical/chemist
	name = OUTFIT_JOB_NAME(JOB_MOEBIUS_CHEMIST)
...
/decl/hierarchy/outfit/job/medical/paramedic
	name = OUTFIT_JOB_NAME(JOB_MOEBIUS_PARAMEDIC)
...
/decl/hierarchy/outfit/job/medical/bioengineer
	name = OUTFIT_JOB_NAME(JOB_MOEBIUS_BIO_ENGINEER)
