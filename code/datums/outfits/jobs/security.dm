...
/decl/hierarchy/outfit/job/security/ihc
	name = OUTFIT_JOB_NAME(JOB_IRONHAMMER_COMMANDER)
...
/decl/hierarchy/outfit/job/security/gunserg
	name = OUTFIT_JOB_NAME(JOB_IRONHAMMER_GUNNERY_SERGEANT)
...
/decl/hierarchy/outfit/job/security/inspector
	name = OUTFIT_JOB_NAME(JOB_IRONHAMMER_INSPECTOR)
...
/decl/hierarchy/outfit/job/security/medspec
	name = OUTFIT_JOB_NAME(JOB_IRONHAMMER_MEDICAL_SPECIALIST)
	l_pocket = /obj/item/device/flash
...
/decl/hierarchy/outfit/job/security/ihoper
	name = OUTFIT_JOB_NAME(JOB_IRONHAMMER_OPERATIVE)
	l_pocket = /obj/item/device/flash
