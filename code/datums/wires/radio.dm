#define RADIO_WIRE_SIGNAL (1 << 0)
#define RADIO_WIRE_RECEIVE (1 << 1)
#define RADIO_WIRE_TRANSMIT (1 << 2)

/datum/wires/radio
	holder_type = /obj/item/device/radio
	wire_count = 3
	descriptions = list(
		new /datum/wire_description(RADIO_WIRE_SIGNAL, "Power"),
		new /datum/wire_description(RADIO_WIRE_RECEIVE, "Reciever"),
		new /datum/wire_description(RADIO_WIRE_TRANSMIT, "Transmitter")
	)
