...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/poster/asters/asterite, 32)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/poster/asters/blurb, 32)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/poster/asters/social_pyramid, 32)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/poster/asters/cev_eris, 32)

/obj/structure/sign/poster/asters/rock_and_stone
	name = "Rock & Stone"
	desc = "\"Rock and stone!\""
	icon_state = "asters_rock_and_stone"
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/poster/asters/rock_and_stone, 32)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/poster/asters/workplace_gaming, 32)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/poster/asters/mine_ore_1, 32)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/poster/asters/mine_ore_2, 32)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/poster/asters/move_freight_1, 32)

/obj/structure/sign/poster/asters/move_freight_2
	name = "Move More Freight"
	desc = "\"Move freight!\""
	icon_state = "asters_move_freight_2"
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/poster/asters/move_freight_2, 32)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/poster/asters/cargonia, 32)
