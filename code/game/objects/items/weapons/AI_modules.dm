...
/obj/item/electronics/ai_module/proc/transmitInstructions(mob/living/silicon/ai/target, mob/sender)
...
/obj/item/electronics/ai_module/proc/log_law_changes(mob/living/silicon/ai/target, mob/sender, law2log)
...
/obj/item/electronics/ai_module/proc/addAdditionalLaws(mob/living/silicon/ai/target, mob/sender)
...
/obj/item/electronics/ai_module/safeguard/attack_self(mob/user as mob)
	..()
...
/obj/item/electronics/ai_module/safeguard/install(obj/machinery/computer/C)
	if(!targetName)
		to_chat(usr, "No name detected on module, please enter one.")
		return 0
	..()

/obj/item/electronics/ai_module/safeguard/addAdditionalLaws(mob/living/silicon/ai/target, mob/sender)
...
/obj/item/electronics/ai_module/oneHuman/attack_self(mob/user as mob)
	..()
...
/obj/item/electronics/ai_module/oneHuman/install(obj/machinery/computer/C)
	if(!targetName)
		to_chat(usr, "No name detected on module, please enter one.")
		return 0
	return ..()

/obj/item/electronics/ai_module/oneHuman/addAdditionalLaws(mob/living/silicon/ai/target, mob/sender)
...
/obj/item/electronics/ai_module/protectStation/addAdditionalLaws(mob/living/silicon/ai/target, mob/sender)
...
/obj/item/electronics/ai_module/prototypeEngineOffline/addAdditionalLaws(mob/living/silicon/ai/target, mob/sender)
...
/obj/item/electronics/ai_module/teleporterOffline/addAdditionalLaws(mob/living/silicon/ai/target, mob/sender)
...
/obj/item/electronics/ai_module/quarantine/addAdditionalLaws(mob/living/silicon/ai/target, mob/sender)
...
/obj/item/electronics/ai_module/oxygen/addAdditionalLaws(mob/living/silicon/ai/target, mob/sender)
...
/obj/item/electronics/ai_module/freeform/attack_self(mob/user as mob)
	..()
...
/obj/item/electronics/ai_module/freeform/addAdditionalLaws(mob/living/silicon/ai/target, mob/sender)
...
/obj/item/electronics/ai_module/freeform/install(obj/machinery/computer/C)
	if(!newFreeFormLaw)
...
/obj/item/electronics/ai_module/reset/transmitInstructions(mob/living/silicon/ai/target, mob/sender)
	log_law_changes(target, sender)
...
/obj/item/electronics/ai_module/purge/transmitInstructions(mob/living/silicon/ai/target, mob/sender)
	log_law_changes(target, sender)
...
/obj/item/electronics/ai_module/freeformcore/attack_self(mob/user as mob)
	..()
	var/newlaw = ""
...
/obj/item/electronics/ai_module/freeformcore/addAdditionalLaws(mob/living/silicon/ai/target, mob/sender)
	var/law = "[newFreeFormLaw]"
	target.add_inherent_law(law)
	GLOB.lawchanges.Add("The law is '[newFreeFormLaw]'")

/obj/item/electronics/ai_module/freeformcore/install(obj/machinery/computer/C)
	if(!newFreeFormLaw)
		to_chat(usr, "No law detected on module, please create one.")
		return 0
	..()
...
/obj/item/electronics/ai_module/syndicate/attack_self(mob/user as mob)
	..()
	var/newlaw = ""
...
/obj/item/electronics/ai_module/syndicate/transmitInstructions(mob/living/silicon/ai/target, mob/sender)
...
/obj/item/electronics/ai_module/syndicate/install(obj/machinery/computer/C)
	if(!newFreeFormLaw)
		to_chat(usr, "No law detected on module, please create one.")
		return 0
	..()
