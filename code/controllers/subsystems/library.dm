...
/datum/controller/subsystem/library/proc/prepare_official_posters()
	...
	for(var/obj/structure/sign/poster/erisposters/poster_type as anything in subtypesof(/obj/structure/sign/poster/erisposters))
...
/datum/controller/subsystem/library/proc/prepare_library_areas()
	library_areas = typesof(/area/eris/crew_quarters/library)
