...
export const MESSAGE_TYPES = [
  ...
  },
  {
    ...
    selector:
      '.alert, .minorannounce, .syndradio, .centcomradio, .aiprivradio, .airadio, .comradio, .ntradio, .secradio, .gangradio, .engradio, .medradio, .sciradio, .supradio, .srvradio, .radio, .deptradio, .binarysay, .resonate, .abductor, .alien, .changeling',
  },
  {
